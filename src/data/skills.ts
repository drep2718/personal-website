...
export const SKILLS: Skill[] = [
  ...
  { name: "ECS",          category: "tool",      level: 3 },
  { name: "Docker",       category: "tool",      level: 3 },
  ...
  { name: "REST",           category: "concept",   level: 2 },
  { name: "RPC",            category: "concept",   level: 2 },
  { name: "Microservices",  category: "concept",   level: 2 },
  ...
  { name: "Keras",          category: "framework", level: 1 },
